...
The configuration-file header action is labeled as advanced configuration. Its tooltip explains that a new file may be empty and account sign-in does not require editing it. Model and account settings remain in their respective panels.
