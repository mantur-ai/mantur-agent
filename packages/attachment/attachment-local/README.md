...
Image admission inspects decoder metadata before rejecting unsupported formats. The dependency minimum is sharp 0.35.4; its bundled libheif 1.23.2 addresses [GHSA-rgj7-g3m4-5g8c](https://github.com/advisories/GHSA-rgj7-g3m4-5g8c). PNG, JPEG, WebP and GIF remain the only admitted formats; an AVIF image is rejected even when the decoder can read its metadata.
