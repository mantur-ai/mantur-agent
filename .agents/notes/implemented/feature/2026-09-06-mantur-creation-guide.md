...
The product composition supplies ordered real Skill names. Homepage shortcuts select exact App-bundled identities under the [bundled Skill decision](2026-09-09-mantur-bundled-skill-identities.md); they do not consult online installation state. More skills retains explicit online installation and ordinary current-composer references. Closing or replacing installation confirmation, switching Sessions, leaving for a marketplace page or unmounting invalidates pending insertion. A plugin-local navigation generation advances before page navigation, preventing late insertion or revival on return. Marketplace Use retains the separate new-Session behavior described in the [marketplace decision](2026-09-03-mantur-marketplace-navigation.md).
