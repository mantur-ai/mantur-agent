...
type LayoutActions = {
  ...
  openMainPage: (draft: LayoutState, page: MainPageId) => void
  closeMainPage: (draft: LayoutState) => void
}
...
export function createLayoutStore(): EngineStoreHandle<LayoutState, LayoutActions>  {
  const handle = defineStore({
    ...
    actions: {
      ...
      openMainPage: (d, page: MainPageId) => { d.mainPage = page },
      closeMainPage: (d) => { d.mainPage = undefined },
    },
  })
  return handle
}
