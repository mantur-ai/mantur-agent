...
const mockedEditingRemote = {
  ...
  resolveId(id: string) {
    if (id === '@deepseek-ai/dsh-client-ui-mantur-editing/remote' || id === '@deepseek-ai/dsh-client-ui-mantur-script/remote'
      || id === '@deepseek-ai/dsh-client-ui-mantur-assets/remote') return id
  },
}
