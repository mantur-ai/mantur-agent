...
- **The complete product name remains visible** — the logo supplements `ManTur Agent` in the expanded sidebar instead of replacing its localized name.
