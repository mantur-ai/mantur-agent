...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'conversation.composer.bar.accessory',
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Product controls above the editor inside the resident composer card.',
    doc: 'Product controls above the editor inside the resident composer card.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    occupants: [
      'client-ui-mantur-navigation ManturComposerAccessory',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.composer.bar.accessory\', () => ctx.slots.register(\n      { name: \'conversation.composer.bar.accessory\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:141',
  },
  {
    key: 'conversation.composer.bar.accessory.permissions',
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Permission control declared by a composer accessory; otherwise rendered in the toolbar.',
    doc: 'Permission control declared by a composer accessory; otherwise rendered in the toolbar.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'conversation.composer.bar.accessory\' (client-ui-mantur-navigation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-conversation PermissionControl',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.composer.bar.accessory.permissions\', () => ctx.slots.register(\n      { name: \'conversation.composer.bar.accessory.permissions\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-mantur-navigation () => null id \'stats\'',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'conversation.composer.guide',
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Product guidance above the resident composer; never owns the editor.',
    doc: 'Product guidance above the resident composer; never owns the editor.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mantur-navigation CreationGuide',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.composer.guide\', () => ctx.slots.register(\n      { name: \'conversation.composer.guide\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:133',
  },
  {
    key: 'conversation.composer.layout',
    kind: 'single',
    scope: 'session-maybe',
    summary: 'Arrange owner-created composer parts without replacing the editor or workspace behavior.',
    doc: 'Arrange owner-created composer parts without replacing the editor or workspace behavior.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mantur-navigation ManturComposerLayout',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.composer.layout\', () => ctx.slots.register(\n      { name: \'conversation.composer.layout\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Optional badge shown after the blank-session headline.',
    doc: 'Optional badge shown after the blank-session headline.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-brand-mantur ManturHeroBadge',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-brand-mantur ManturHeroBrand',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Deployment-specific blank-session headline.',
    doc: 'Deployment-specific blank-session headline.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-brand-mantur ManturHeroHeadline',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'conversation.hero.modes',
    kind: 'single',
    scope: 'root',
    summary: 'Product-owned creation choices below the blank-conversation headline.',
    doc: 'Product-owned creation choices below the blank-conversation headline.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mantur-navigation CreationModes',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.hero.modes\', () => ctx.slots.register(\n      { name: \'conversation.hero.modes\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Root-level page replacing the center conversation surface while active.',
    doc: 'Root-level page replacing the center conversation surface while active.\nThe layout keeps the conversation mounted but hidden, and the transient\nselection resets to conversation on reload.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mantur-navigation MarketplacePage',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mantur-script Workbench',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'main.workbench.assets.content',
    kind: 'single',
    scope: 'root',
    summary: 'Asset drafts remain mounted across same-Session content switches.',
    doc: 'Asset drafts remain mounted across same-Session content switches.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'main.workbench\' (client-ui-mantur-script), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mantur-assets AssetsPanel',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'main.workbench.assets.content\', () => ctx.slots.register(\n      { name: \'main.workbench.assets.content\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-mantur-script/src/client/index.ts:34',
  },
  {
    key: 'main.workbench.assets.tab',
    kind: 'single',
    scope: 'root',
    summary: 'Optional asset tab; its plugin owns its label and availability.',
    doc: 'Optional asset tab; its plugin owns its label and availability.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'main.workbench\' (client-ui-mantur-script), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mantur-assets AssetTab',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'main.workbench.assets.tab\', () => ctx.slots.register(\n      { name: \'main.workbench.assets.tab\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-mantur-script/src/client/index.ts:32',
  },
  {
    key: 'main.workbench.editing.content',
    kind: 'single',
    scope: 'root',
    summary: 'Editing stays mounted after first activation within this Session.',
    doc: 'Editing stays mounted after first activation within this Session.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'main.workbench\' (client-ui-mantur-script), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mantur-editing Workbench',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'main.workbench.editing.content\', () => ctx.slots.register(\n      { name: \'main.workbench.editing.content\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-mantur-script/src/client/index.ts:38',
  },
  {
    key: 'main.workbench.editing.tab',
    kind: 'single',
    scope: 'root',
    summary: 'Optional editing tab; its plugin owns its label and availability.',
    doc: 'Optional editing tab; its plugin owns its label and availability.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'main.workbench\' (client-ui-mantur-script), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mantur-editing EditingTab',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'main.workbench.editing.tab\', () => ctx.slots.register(\n      { name: \'main.workbench.editing.tab\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-mantur-script/src/client/index.ts:36',
  },
  {
    key: 'main.workbench.toggle',
    kind: 'single',
    scope: 'root',
    summary: 'Optional workbench visibility control on the conversation\'s right boundary.',
    doc: 'Optional workbench visibility control on the conversation\'s right boundary.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mantur-script WorkbenchToggle',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'main.workbench.toggle\', () => ctx.slots.register(\n      { name: \'main.workbench.toggle\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-layout/src/client/index.ts:86',
  },
  {
    key: 'main.workbench.toggle.editing',
    kind: 'single',
    scope: 'root',
    summary: 'Resident live-opening observer with explicit editing selection.',
    doc: 'Resident live-opening observer with explicit editing selection.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'main.workbench.toggle\' (client-ui-mantur-script), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mantur-editing WorkbenchToggle',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'main.workbench.toggle.editing\', () => ctx.slots.register(\n      { name: \'main.workbench.toggle.editing\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-mantur-script/src/client/index.ts:40',
  },
  {
    key: 'root',
    kind: 'single',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-mantur-navigation DesktopUpdateSettings id \'mantur.desktop-update\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-mantur-account NativeAccountSection id \'mantur-account\'',
      'client-ui-mantur-account AccountSection id \'mantur-account\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mantur-account NativeAccountDialog id \'mantur-account\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-brand-mantur ManturSidebarMark',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-brand-mantur ManturSidebarName',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mantur-account AccountBalance id \'mantur.balance\'',
      'client-ui-mantur-navigation DesktopUpdate id \'mantur.desktop-update\'',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Optional product navigation rendered above the workspace browser.',
    doc: 'Optional product navigation rendered above the workspace browser.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mantur-navigation MarketplaceNavigation',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'sidebar.workspaces.heading',
    kind: 'single',
    scope: 'root',
    summary: 'Deployment-owned terminology for the grouped workspace section heading.',
    doc: 'Deployment-owned terminology for the grouped workspace section heading.',
    registerOptions: [],
    ownerProps: [
      '/** Empty owner share for deployment-specific workspace terminology. */\nexport interface WorkspaceHeadingOwnerProps {\n  /** Marker field: the occupant owns only the rendered label. */\n  children?: never\n}',
    ],
    ownerPropsReferences: [],
    standardProps: [
      'useWorkspaces: SnapshotSelectorHook<WorkspaceSnapshot>',
    ...
    declaredBy: 'an entry in \'sidebar.workspaces\' (client-ui-workspace), so it exists while that entry is mounted',
    occupants: [
      'client-ui-mantur-navigation ProjectsHeading',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.workspaces.heading\', () => ctx.slots.register(\n      { name: \'sidebar.workspaces.heading\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
