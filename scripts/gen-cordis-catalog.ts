...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ManturHubRequestOptions: 'credentials.md',
  ManturMarketplaceCatalog: 'skills.md',
  ManturMarketplaceRecipeCatalog: 'skills.md',
  ManturMarketplaceRecipeDetail: 'skills.md',
  ManturMarketplaceRecipeQuery: 'skills.md',
  ManturMarketplaceSkillDetail: 'skills.md',
  ManturMarketplaceInstallResult: 'skills.md',
