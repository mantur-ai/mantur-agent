...
export const zh = {
  ...
  'empty': '当前目录还没有这个方向的推荐技能，可以前往侧栏技能广场查看。',
  'more': '更多技能',
...
export const en = {
  ...
  'empty': 'No recommended skills for this direction are in the current catalog. Open the Skill marketplace in the sidebar.',
  'more': 'More skills',
