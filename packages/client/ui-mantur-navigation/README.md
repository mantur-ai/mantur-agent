...
Below 820px viewport width, the hero recommendation row reserves 40px of additional vertical space for a readable scroll area below the tabs. The same space remains while the guide is closed, so toggling it does not move the input card or automatic-project footer.
