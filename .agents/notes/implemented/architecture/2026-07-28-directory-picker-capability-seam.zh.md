...
原生能力专有的停止方法遵循[子进程关闭所有权决策](../bug-fix/2026-09-07-native-picker-shutdown-join.zh.md)，不改变原生与浏览交互的拆分，也不增加 Remote 停止动词。
