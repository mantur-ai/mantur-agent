...
const en = {
  ...
  updateReadyMessage: (version: string) => `Mantur Agent ${version} has finished downloading. Restarting will interrupt tasks running in this client. Remote tasks are not cancelled, and some tasks may need to be started again. Restart and install?`,
