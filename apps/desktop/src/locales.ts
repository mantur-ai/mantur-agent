...
const zh = {
  ...
  startupFailedTitle: 'ManTur Agent 启动失败',
  ...
  updateReadyMessage: (version: string) => `ManTur Agent ${version} 下载完成，重启安装。重启会中断当前客户端正在执行的任务；远端任务不会因此取消，部分任务需要重新发起。是否继续？`,
  restartButton: '重启并更新',
  aboutMenu: '关于ManTur Agent',
  editMenu: '编辑',
  viewMenu: '显示',
  windowMenu: '窗口',
  helpMenu: '帮助',
